...
class Nlp:
    ...
    def initialize_nlp(self):
        ...
        #Paquete de datos que contiene modelos y recursos para la tokenizaciÃ³n de texto en diferentes idiomas. 
    ...
    def lem_tokens(self, tokens):
        """Lematiza las palabras base (lema): "corriendo", "corre", "corriÃ³" --> "correr".
    ...
    def lem_normalize(self, text):
        ...
        #word_tokenize --> divide un texto o una oraciÃ³n en una lista de palabras o tokens individuales.
        #                   "Hello, how are you today?" --> ['Hello', ',', 'how', 'are', 'you', 'today', '?']
        
        #Devuelve un texto normalizado (convierte a minusculas, elimina puntuciaciÃ³n y lematiza)
    ...
    def response(self, user_response):
        ...
        #Obtiene el valor mÃ¡s similar usando metodo de similitud de coseno
        vals = cosine_similarity(tfidf[-1], tfidf)
        
        #Obtiene el Ã­ndice de respuestas para elegir de la matriz ([-2]: Ãºltimos 2 elementos)
        #Respuesta mÃ¡s similar
             ...
             if "bye" in user_response.lower():
                ...
                try:
                     ...
                     if 'list files' in user_response:
                         ...
                         # Encontrar los Ã­ndices de las palabras clave "move" y "to"
